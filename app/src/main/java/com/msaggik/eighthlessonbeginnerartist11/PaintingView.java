...
public class PaintingView extends View {
    ...
    private Paint paint, copyPaint; // поле задания стиля рисования
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(bitmap, 0, 0, copyPaint); // запись на холсте отрисованных линий
    ...
    public void setSize(int size) {
        paint.setStrokeWidth(size); // задаём свойства кисти
    }
}